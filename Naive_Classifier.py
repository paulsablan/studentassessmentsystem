...
def predict_grades(filename, summaries_second_half, summaries_final):
	labels, data, test = load_csv_clean(filename, 100)
	# Data for Second Half Grade
	test_second_half = []
	for i in data:
		j = i[0:-1]
